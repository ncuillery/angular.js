/**
 * @license AngularJS v1.3.0-local+sha.bd131bb
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.3.0-local+sha.bd131bb/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.3.0-local+sha.bd131bb',    // all of these placeholder strings will be replaced by grunt's
...
function $RootScopeProvider(){
  ...
  this.$get = ['$injector', '$exceptionHandler', '$parse', '$browser',
    ...
    Scope.prototype = {
      ...
      $broadcastNew: function(name, args) {
        function Event(currentScope) {
          this.name = name;
          this.currentScope = currentScope;
          this.targetScope = target;
